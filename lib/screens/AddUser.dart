...
class _AddUserState extends State<AddUser> {
  ...
  pickImage(ImageSource imageType) async {
    try {
      ...
      // String imgString = Utility.base64String(loPhoto.readAsBytesSync()) ;
      moPickedImage = File(loPhoto.path);
      setState(() {
        // moPickedImage = loTempImage;
        msImagePath = loPhoto.path;
        debugPrint("My Image path " + msImagePath);
        // final bytes = Io.File(loPhoto.path).readAsBytesSync();
        // msImg64 = base64Encode(bytes);
        // print(msImg64!.substring(0, 100));
      });
